...
{
	int id = 0, i = 0;
	char nom[50], prenom[50], mail[50], num[50];
...
int delete_user(FILE *fp)
{
	...
	printf("Veuillez saisir l'id de la personne a supprimer :\n");
	scanf("%d", &choix);
	new = fopen("tmp.txt", "w+");
	while (i == 5) {
...
{
	int id = 0, i = 0, j = 0;
	char name[50], nom[50], prenom[50], mail[50], num[50];
